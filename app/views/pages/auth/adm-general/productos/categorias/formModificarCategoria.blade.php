        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Modificar categoría</li>
                </ol>
            </nav>              
        </div>
        <div class="col-12">
            <form action="{{route('auth/categorias/modificar-categoria/actualizar')}}" method="POST">
                <input type="hidden" name="id_categ" value="{{$categoria['id_categ']}}">
                        ...
                        <section class="row g-3 m-0">
                            <div class="col-12 col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="nombrecat" id="input_nombrecat" placeholder="" aria-label="" value="{{$categoria['nombrecat']}}">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="orden" id="input_orden" min="0" value="{{$categoria['orden']}}" step=".01" placeholder="" aria-label="">
                                    <div class="invalid-feedback" id="msgOrden"></div>
                                </div>                              
                            </div>
                            <div class="col-12">
                                <span class="input-group-text">Descripción corta *</span>
                                <textarea class="form-control" name="descri_c" id="input_descri_c" rows="3" placeholder="" aria-label="">{{$categoria['descri_c']}}</textarea>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="descri_l" id="input_descri_l" rows="3" placeholder="" aria-label="">{!! $categoria['descri_l'] !!}</textarea>
                                <div class="invalid-feedback" id="msgDescriL"></div>                                            
                            </div>
                            <div class="col-12 text-center">
                                <input type="hidden" name="imagen" id="input_imagen" value="{{$categoria['imagen']}}">
                                ...
                                <div class="text-center d-flex justify-content-center align-items-center mb-2" id="vista_previa">
                                    @if($categoria['imagen'] != '')
                                        <img src="{{$categoria['imagen']}}" style="max-width:250px;max-height:300px" class="rounded shadow-sm" alt="img_not_found">
                                    @else
                            ...
                            <div class="col-12 col-md-6 text-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center flex-wrap">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="visible" id="checkVisible" value="S" {{$categoria['visible'] == 'S' ? 'checked' : ""}}>
                                        <label class="form-check-label" for="checkVisible"><span class="badge bg-success">Visible</span></label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="visible" id="checkNoVisible" value="N" {{$categoria['visible'] == 'N' ? 'checked' : ""}}>
                            ...
                            <div class="col-12 col-md-6 text-center">
                                ...
                                <input type="color" name="color" id="input_color" value="{{$categoria['color']}}">
