...
@section('content')
    <section class="row m-0 justify-content-center p-4">
        ...
        <div class="col-12">
            <form action="{{route('auth/producto/editor-productos/actualiar-producto')}}" method="POST">
                ...
                <section class="row m-0 justify-content-center">
                    <div class="col-12 col-md-10 col-lg-8 col-xl-8 p-3 border rounded shadow-sm">
                        <h5 class="text-center">Modificar producto</h5>
                        <hr>
                        ...
                        <section class="row m-g g-3">
                            <div class="col-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="nombreprod" id="input_nombreprod" placeholder="" aria-label="" value="{{$producto['nombreprod']}}">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="nro_art" id="input_nro_art" placeholder="" aria-label="" min="0" value="{{$producto['nro_art']}}">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="orden" id="input_orden" placeholder="" aria-label="" min="0" step=".01" value="{{$producto['orden']}}">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="precio" id="input_precio" placeholder="" aria-label="" min="0" value="{{$producto['precio']}}">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-text">$</span>
                                    <input type="number" class="form-control" name="precio_unitario" id="input_precio_unitario" placeholder="" aria-label="" min="0" value="{{$producto['precio_unitario']}}">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="input-group">
                                    ...
                                    <select class="form-select" name="haystock" aria-label="Default select example">
                                        <option value="S" {{$producto['stock'] == "S" ? "selected" : ""}}>Si</option>
                                        <option value="N" {{$producto['stock'] == "N" ? "selected" : ""}}>No</option>
                                    </select>
                                </div>                                  
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="input-group">
                                    ...
                                    <select class="form-select" name="visible" aria-label="Default select example">
                                        <option value="S" {{$producto['visible'] == "S" ? "selected" : ""}}>Si</option>
                                        <option value="N" {{$producto['visible'] == "N" ? "selected" : ""}}>No</option>
                                    </select>
                                </div>                                  
                            </div>
                            <div class="col-12">
                                ...
                                <div class="d-flex justify-content-start align-items-center flex-wrap p-1">
                                    <div>
                                        <div class="form-check form-check-inline border shadow-sm bg-light">
                                            <input class="form-check-input talles_selector" name="talles[]" type="checkbox" id="check_talle_35" value="35" {{ in_array('35' ,$talles_asignados_array) ? 'checked' : "" }}>
                                            <label class="form-check-label cursor-pointer" for="check_talle_35"><span class="badge text-dark fs-5">35</span></label>
                                        </div> 
                                    </div>
                                    <div>
                                        <div class="form-check form-check-inline border shadow-sm bg-light">
                                            <input class="form-check-input talles_selector" name="talles[]" type="checkbox" id="check_talle_36" value="36" {{ in_array('36' ,$talles_asignados_array) ? 'checked' : "" }}>
                                            <label class="form-check-label cursor-pointer" for="check_talle_36"><span class="badge text-dark fs-5">36</span></label>
                                        </div> 
                                    </div>
                                    <div>
                                        <div class="form-check form-check-inline border shadow-sm bg-light">
                                            <input class="form-check-input talles_selector" name="talles[]" type="checkbox" id="check_talle_37" value="37" {{ in_array('37' ,$talles_asignados_array) ? 'checked' : "" }}>
                                            <label class="form-check-label cursor-pointer" for="check_talle_37"><span class="badge text-dark fs-5">37</span></label>
                                        </div> 
                                    </div>
                                    <div>
                                        <div class="form-check form-check-inline border shadow-sm bg-light">
                                            <input class="form-check-input talles_selector" name="talles[]" type="checkbox" id="check_talle_38" value="38" {{ in_array('38' ,$talles_asignados_array) ? 'checked' : "" }}>
                                            <label class="form-check-label cursor-pointer" for="check_talle_38"><span class="badge text-dark fs-5">38</span></label>
                                        </div> 
                                    </div>
                                    <div>
                                        <div class="form-check form-check-inline border shadow-sm bg-light">
                                            <input class="form-check-input talles_selector" name="talles[]" type="checkbox" id="check_talle_39" value="39" {{ in_array('39' ,$talles_asignados_array) ? 'checked' : "" }}>
                                            <label class="form-check-label cursor-pointer" for="check_talle_39"><span class="badge text-dark fs-5">39</span></label>
                                        </div> 
                                    </div>
                                    <div>
                                        <div class="form-check form-check-inline border shadow-sm bg-light">
                                            <input class="form-check-input talles_selector" name="talles[]" type="checkbox" id="check_talle_40" value="40" {{ in_array('40' ,$talles_asignados_array) ? 'checked' : "" }}>
                                            <label class="form-check-label cursor-pointer" for="check_talle_40"><span class="badge text-dark fs-5">40</span></label>
                                        </div> 
                                    </div>
                                    <div>
                                        <div class="form-check form-check-inline border shadow-sm bg-light">
                                            <input class="form-check-input talles_selector" name="talles[]" type="checkbox" id="check_talle_41" value="41" {{ in_array('41' ,$talles_asignados_array) ? 'checked' : "" }}>
                                            <label class="form-check-label cursor-pointer" for="check_talle_41"><span class="badge text-dark fs-5">41</span></label>
                                        </div> 
                                    </div>
                                    <div>
                                        <div class="form-check form-check-inline border shadow-sm bg-light">
                                            <input class="form-check-input talles_selector" name="talles[]" type="checkbox" id="check_talle_es" value="es" {{ in_array('es' ,$talles_asignados_array) ? 'checked' : "" }}>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control no-resize" name="descri_c" id="input_descri_c" rows="3">{{ $producto['descri_c'] }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="descri_l" id="input_descri_l" rows="3">{!! $producto['descri_l'] !!}</textarea>
                            ...
                            <div class="col-12">
                                ...
                                <div class="d-flex justify-content-start align-items-center flex-wrap p-1">
                                    @foreach($categorias as $categoria)
                                        <div class="form-check form-check-inline border shadow-sm bg-light">
                                            <input class="form-check-input categ_selector" name="ids_categ[]" type="checkbox" id="check_categ_{{$categoria['id_categ']}}" value="{{$categoria['id_categ']}}" {{ in_array($categoria['id_categ'], array_column($categorias_asignadas, "id_categ")) ? "checked" : "" }}>
...
@section('footer-scripts')
    ...
    <script>
        ...
        const PREV_IMAGENES = JSON.parse('{!! addslashes($json_imagenes_asignadas) !!}');
    </script>
